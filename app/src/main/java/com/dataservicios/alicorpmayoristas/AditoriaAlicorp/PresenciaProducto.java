...
import com.dataservicios.alicorpmayoristas.adapter.ProductsAdapter;
import com.dataservicios.alicorpmayoristas.adapter.PublicityAdapter;
...
//        getActionBar().setTitle(au.getName());
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Intent intent = new Intent("com.dataservicios.alicorpmayoristas.DETAIPUBLICITY");
